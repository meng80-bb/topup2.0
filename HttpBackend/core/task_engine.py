...
class TaskEngine:
    ...
    def pause_task(self, task_id: int) -> Dict[str, Any]:
        ...
        try:
            # 实现暂停逻辑
            state_manager.set_task_status(task_id, state_manager.TaskStatus.PAUSED)
            task.status = 'paused'
            db.session.commit()
    ...
    def cancel_task(self, task_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            # 更新任务状态
            state_manager.set_task_status(task_id, state_manager.TaskStatus.CANCELLED)
    ...
    def _execute_task(self, task_id: int):
        ...
        try:
            ...
            for i, step_config in enumerate(steps, 1):
                if state_manager.get_task_status(task_id) != state_manager.TaskStatus.RUNNING:
    ...
    def _complete_task(self, task_id: int):
        ...
        if task:
            ...
            state_manager.set_task_status(task_id, state_manager.TaskStatus.SUCCESS)
    ...
    def _fail_task(self, task_id: int, error_message: str):
        ...
        if task:
            ...
            state_manager.set_task_status(task_id, state_manager.TaskStatus.FAILED)
